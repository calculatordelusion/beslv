<script>
	...
	// Date navigation computation for today
	$: navDates = (() => {
...
<svelte:head>
	<title>Today's NYT Spelling Bee Pangram & Pangrams | Spelling Bee Solver</title>
	<meta name="description" content="Reveal today's NYT Spelling Bee pangram(s) and honeycomb letters for {puzzle.formattedDate}, plus quick links to full hints and answers." />
</svelte:head>
...
<div class="bg-gray-50 py-12">
	<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<div class="text-center mb-8">
			...
			{/if}
			<h1 class="text-4xl font-bold text-gray-900 mb-2">Today's NYT Spelling Bee Pangram</h1>
		...
		<div class="bg-white rounded-lg shadow-md p-6 mb-6">
			<h2 class="text-2xl font-bold mb-4">Today's NYT Spelling Bee Pangrams</h2>
		...
		<div class="mt-8 flex gap-4 justify-center">
			<a href="/hints" class="text-blue-600 hover:text-blue-800 font-medium">View Hints</a>
			<a href="/answers" class="text-blue-600 hover:text-blue-800 font-medium">View All Answers</a>
